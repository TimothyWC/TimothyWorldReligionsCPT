      ...
      <section className="content-section" style={{ background: 'var(--faith-surface)' }}>
        <div className="content-section-inner">
          <div className="content-full">
            ...
            <p>
              I watched a part of this show to get a deeper perspective on Jewish media and what it means to
              be Jewish for this CPT. What stood out to me immediately is how personal everything feels like
              I expected the show to feel foreign and disconnected from my life, but the family dynamics, the
              father-son tension between Shulem and Akiva, the pressure to live up to their parents'
              expectations I could relate to all of it. Akiva wants to be an artist but his community doesn't
              really support this path, and I can relate to that feeling of wanting something different from
              what people actually expect from you. This show taught me that Ultra-Orthadox jews aren't just
              “rule following, suit wearing, Strict, non-modern” Jews but they are obviously people with the
              same emotions, love, grief, ambitions, loneliness like everyone else. Shtisel does exactly what
              good media should do: it makes you understand a group of people you thought were completely
              different from you and realize you have more in common than you think.
            </p>
          </div>
        </div>
      </section>
