    ...
    <footer className={styles.footer}>
      <div className={styles.inner}>
        <div className={styles.brand}>
          ...
          <p className={styles.tagline}>A scholarly exploration of the world's great religious traditions.</p>
        </div>
        <div className={styles.links}>
          <p className={styles.colHead}>Traditions</p>
          <ul>
      ...
      <div className={styles.bottom}>
        <p>© {new Date().getFullYear()} Religion CPT — A Grade 12 culminating performance task.</p>
      </div>
    </footer>
  );
}
